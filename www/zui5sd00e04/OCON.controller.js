sap.ui.controller("zui5sd00e04.OCON", {
	...
	getCTX: function(){
		...
		oModel.setData({
			...
			wei_rcv		: '',
			wei_tare	: '',
			//host		: 'http://cpfdv6.cpf.co.th:8000',
			//client		: '220',
			//host		: 'http://cpfrpt06.cpf.co.th:8002',
			//client		: '888',
			//host		: 'http://cpfsapgw.cpf.co.th:8000',
			//client		: '444',
			//host		: 'http://sapwebe1.cpf.co.th:8011',
			host		: 'https://10.244.50.123:44300',
			client		: '666',
			cancel_nav 	: false,
			oEvt		: null,
			rendered 	: false,
...
//		};
	...
	onDeviceReady: function(){
		...
		oCon.getControl('a002InpUUID').setValue(device.uuid);
